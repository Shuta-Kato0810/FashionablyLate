            ...
            <div class="confirm-table">
                <table class="confirm-table__inner">
                    ...
                    <tr class="confirm-table__row">
                        ...
                        <tr class="confirm-table__text">
                            <input type="id" name="bigint unsigned" value="商品の紹介について" />
                        </tr>
                    </tr>
                    <tr class="confirm-table__row">
                        <th class="confirm-table__header">お問い合わせ内容</th>
                        <tr class="confirm-table__row">
                            <input type="varchar(255)" name="content" value="届いた商品ではありませんでした。<br />商品の取り替えをお願いします。" />
                        </tr>
                    </tr>
                </table>
            </div>
